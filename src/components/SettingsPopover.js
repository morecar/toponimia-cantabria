            ...
            <div className="row g-3">
              ...
              <div className="col-6 col-md-3">
                <Form.Group>
                  ...
                  <Form.Check defaultChecked={this.props.config.resultsTypes.includes('line')}  label={this.props.loc.get("result_class_line")}  type='checkbox' id='toggle-lines' disabled/>
                  <Form.Check defaultChecked={this.props.config.resultsTypes.includes('poly')}  label={this.props.loc.get("result_class_poly")}  type='checkbox' id='toggle-polygons' disabled/>
                </Form.Group>
              </div>
              <div className="col-6 col-md-3">
                <Form.Group>
